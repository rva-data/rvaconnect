...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'places_place', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Place.description'
        raise RuntimeError("Cannot reverse this migration. 'Place.description' and its values cannot be restored.")
