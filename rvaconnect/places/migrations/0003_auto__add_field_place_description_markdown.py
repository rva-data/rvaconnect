...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.description_markdown'
        db.add_column(u'places_place', 'description_markdown',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.description_markdown'
        db.delete_column(u'places_place', 'description_markdown')
